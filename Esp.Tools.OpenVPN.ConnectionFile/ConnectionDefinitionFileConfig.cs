...
{
    [DataContract]
    public class ConnectionDefinitionFileConfig
    {
        internal ConnectionDefinitionFileConfig(ConnectionDefinitionFileLocks pLocks)
        {
            Locks = pLocks;
        }
        [DataMember]
        public ConnectionDefinitionFileLocks Locks { get; private set; }

        [DataMember]
        public bool AutoStart { get; set; }

        [DataMember]
        public ConnectionSaveLevel AuthSaveLevel { get; set; }
