    ...
    public class CertificateManager
    {
        ...
        public string GenerateRequest(EnrollRequestDetails pDetails)
        {
            ...
            try
            {
                ...
                switch (pDetails.Algorithm)
                {
                    case EnrollRequestCertAlgorithm.RSA4096:
                        objPrivateKey.Length = 4096;
                        objPrivateKey.KeySpec = X509KeySpec.XCN_AT_SIGNATURE;
                        break;
                    case EnrollRequestCertAlgorithm.ECDSA_P384:
                        ...
                        break;
                    default:
                        throw new InvalidProgramException("Request for invalid cert type");
