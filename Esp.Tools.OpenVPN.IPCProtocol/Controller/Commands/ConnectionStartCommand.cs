...
namespace Esp.Tools.OpenVPN.IPCProtocol.Controller.Commands
{
    public class ConnectionStartCommand : BaseMessage<ConnectionStartInfo>
    {
        public ConnectionStartCommand()
        {
            Code = "Start";
        }
    }
